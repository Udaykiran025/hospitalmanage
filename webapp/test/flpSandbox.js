		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#hospitalmanage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hospitalmanage-display": {
								"semanticObject": "hospitalmanage",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hospitalmanage",
									"url": sap.ui.require.toUrl("hospitalmanage")
								}
							}
						}
					}
